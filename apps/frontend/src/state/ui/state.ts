...
export class UIStateManager {
    ...
    getSidebarOpen(): boolean {
        return queryClient.getQueryData<boolean>(stateKeys.ui.sidebarOpen()) ?? true;
    }
    ...
    getCurrentModal(): string | null {
        return queryClient.getQueryData<string | null>(stateKeys.ui.currentModal()) ?? null;
    }
    ...
    getTheme(): 'light' | 'dark' | 'system' {
        return queryClient.getQueryData<'light' | 'dark' | 'system'>(stateKeys.ui.theme()) ?? 'system';
    }
    ...
    getNotifications(): Notification[] {
        return queryClient.getQueryData<Notification[]>(stateKeys.ui.notifications()) ?? [];
    }
    ...
    addNotification(notification: Omit<Notification, 'id'>): void {
        ...
        queryClient.setQueryData(stateKeys.ui.notifications(), [...notifications, newNotification]);
    }
    ...
    getIsCommandPaletteOpen(): boolean {
        return queryClient.getQueryData<boolean>(stateKeys.ui.commandPaletteOpen()) ?? false;
    }
