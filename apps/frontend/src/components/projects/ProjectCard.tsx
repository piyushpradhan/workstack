        ...
        >
            <div className="flex items-start justify-between mb-3">
                <div className="flex-1 min-w-0">
                    <h3 className="text-card-foreground mb-1 text-base truncate">{project.name}</h3>
            ...
            <div className="space-y-2.5 mb-3">
                <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="text-primary text-sm flex-shrink-0">{completionRate}%</span>
                </div>
                        ...
                        {members.slice(0, 3).map((member) => {
                            return (
                                <div
                                    ...
                                    title={member.name}
                                >
                                    <span className="text-primary-foreground text-xs">{member.name.charAt(0)}</span>
                                </div>
                            )
                        })}
                        {members.length > 3 && (
