...
import { Plus, Search, Grid3x3, List, AlertCircle, RefreshCw } from 'lucide-react';
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        <div className="flex items-center gap-2 bg-muted border rounded-md p-1" role="tablist" aria-label="Project filters">
                            <button
                        ...
                        <div className="flex items-center gap-1 bg-muted border rounded-md p-1" role="group" aria-label="View mode">
                            <button
                ...
                {filteredProjects.length > 0 ? (
                    ...
                    <div className="text-center py-12" role="region" aria-label="No projects found">
