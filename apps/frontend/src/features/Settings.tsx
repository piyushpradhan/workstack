...
export default function Settings() {
    ...
    const handleSaveProfile = async () => {
        try {
            ...
            if (form.profileDisplayName !== (user?.name ?? '')) payload.name = String(form.profileDisplayName || '');
            if (form.email !== (user?.email ?? '')) payload.email = String(form.email || '');
    ...
    const handleChange = (field: keyof typeof form, value: string | boolean | number) => {
        ...
        <ErrorBoundary>
            <div className="p-4 md:p-6 space-y-6 max-w-3xl">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Manage your profile, notifications, and app preferences</p>
                </div>
                ...
                <div className="bg-card border border-border rounded-lg p-4 md:p-6 space-y-6 shadow-sm">
                    <section className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => handleChange('profileDisplayName', e.target.value)}
                        ...
                        <div className="flex justify-end">
                            <Button type="button" onClick={handleSaveProfile} disabled={updateUser.isPending}>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-foreground text-base md:text-lg">Preferences</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-foreground text-base md:text-lg">Notifications</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label className="flex items-center gap-3 select-none cursor-pointer">
                                <input
                                    type="checkbox"
                    ...
                    <section className="space-y-4">
                        <h2 className="text-foreground text-base md:text-lg">Email Digest</h2>
                        <p className="text-muted-foreground text-sm">Get a summary of activity delivered on a schedule.</p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="digest">Digest Frequency</Label>
                                <Select
                                    value={form.notificationsDigest}
                                    onValueChange={(value) => handleChange('notificationsDigest', value)}
                                >
                                    <SelectTrigger className="w-full">
                                        <SelectValue />
                                    </SelectTrigger>
